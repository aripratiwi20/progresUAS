...
import { StyleSheet, View, Alert, TextInput, Button, Text, Platform, TouchableOpacity, ListView, ActivityIndicator,Image } from 'react-native';
...
<View style={styles.MainContainer}>
      ...
      <TouchableOpacity activeOpacity = { .4 } style={styles.TouchableOpacityStyle} onPress={this.GoTo_Show_StudentList_Activity_Function} >
        ...
        <Text style={styles.TextStyle}> LIHAT DAFTAR MAHASISWA </Text>
